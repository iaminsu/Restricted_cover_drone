...
class Convexpath_shapely():
    def __init__(self, path, origin, destination, obstacles):

        self.obstaclesPolygons = obstacles
        self.path = path       

        self.esp = self.createConvexPath([(origin, destination)])
...
#path_air = "/Users/insuhong/Dropbox/research/Distance restricted covering model/Locating recharging station/data/"
#path_ubuntu = "/home/insu/Dropbox/research/Convexpath Approach/HPC/data/"

#start = time.time()
#a = Convexpath(path_air, "sample_sites_2_1.shp", "sample_sites_2_2.shp", "obstacles_p.shp")
