...
ffDict = "FF_Dict_Convexpath_Sequential_sample_sites_2.shp_sample_demand_2.shp_obstacles.txt"
fdDict = "FD_Dict_Convexpath_Sequential_sample_sites_2.shp_sample_demand_2.shp_obstacles.txt"
dDict = "demands.txt"
facilities_f = "sample_sites_2.shp"
demands_f = "sample_demand_2.shp"
            ...
            for c in candis:
                ...
                if c == site:
                    ...
                    if temp2_obj > current_obj[1]:
                        if chk_feasibility(temp2_sol, False):
                            flag = False
                            in_solution = []
...
def random_fill(in_solution=[]):
    ...
    while isolation == True:
        ...
        if chk_feasibility(new_sol, False):
            in_solution = []
...
print "random solution initialized"
